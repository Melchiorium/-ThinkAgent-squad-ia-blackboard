...
le navigateur Chromium attendu par Puppeteer dans `.cache/puppeteer` du
repo. C'est ce qui rend `architecture-diagram.png` possible sur Render au
lieu de laisser seulement `architecture-diagram.mmd`.
